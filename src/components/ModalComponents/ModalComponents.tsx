...
export const ModalComponents = ({ closeModal, title }: ModalProps) => {
  return (
    <div
      onClick={closeModal}
      className="w-full h-screen bg-black/80  fixed top-0 left-0 flex justify-center items-center z-20  "
    >
      <div className="w-full md:w-3/4 h-[550px]  xl:h-[650px] bg-[#053b50]/95 z-50 mt-10 md:mt-20 p-5 flex flex-col justify-center items-center mb-10 md:mb-0  ">
            ...
            return (
              ...
              >
                <div className="w-full md:w-3/4 relative  bottom-5 text-center">
                  <h2 className="text-sm md:text-xl xl:text-3xl">
                    {item.title}
                  </h2>
