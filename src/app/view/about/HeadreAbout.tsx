  ...
  return (
    <div className="w-[90%] md:w-[70%] h-14 md:h-32 flex justify-around md:items-end md:pb-5 relative md:top-10">
      <span
        ...
        className={`w-1/3 text-primary dark:text-primaryDark bg-transparent text-sm md:text-lg hover:border-secondary flex justify-center items-center capitalize font-roboto cursor-pointer ${
          view === "about"
